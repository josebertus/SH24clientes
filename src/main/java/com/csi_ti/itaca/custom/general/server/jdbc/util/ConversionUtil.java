package com.csi_ti.itaca.custom.general.server.jdbc.util;
...
public class ConversionUtil {
    ...
    public static String getDefaultLocale() {
        try {
            BigDecimal defaultCIDIOMA=AxisBaseService.stringToBigDecimal(ConfigCache.getConfig().getProperty("locale.defecto"));
    ...
    public static String getLocaleSeparadorDecimales() {    	
    	try {
    		if("USA".equals(getLocaleFormatoNumerico())) return ".";
    		else return ",";
        }
        catch (Exception e) {
        	return ",";
